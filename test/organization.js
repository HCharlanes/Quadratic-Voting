  ...
  //   // it("Should let anyone create an organization with the right parameters", function(done) {
  //   //   //var o = Organizations.at(Organization.deployed_address);
      
  //   //   Organizations.new({from: creator}).then(
  //   //     function(contract) {
  //   //     	console.log(0)
  //   //       contract.NewOrganization("FirstOrg", 100, {from: member1}).then(
  //   //         function() { 
  //   //          return contract.organizations.call(0);
  //   //          console.log(2)
  //   //       }).then(
  ...
  //   //       }).then(
  //   //         function(name) { 
  //   //           assert.equal(name, "FirstOrg", "Count doesn't match!"); 
  //   //      /* }).then(
  //   //         function() { 
